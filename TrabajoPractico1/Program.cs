...
namespace TrabajoPractico1
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            //b.altaUsuario("Cosme","Fulanito",1234,"cosmefulanito@gmail.com","contrase�a indescifrable");
            //b.altaUsuario("Tipo","De incognito",5689,"tipodeincognito@gmail.com","contrase�a indescifrable");

            //foreach (Usuario u  in b.usuarios){Debug.WriteLine("Alta usuario: " + u);}

            //b.modificarUsuario(5689,"tipo@gmail.com","contrase�a");
            ...
            //b.altaUsuario("Usuario", "Random", 1111, "ur@gmail.com", "contrase�a random");
            ...
            //foreach (Tarjeta t in b.tarjetas) { Debug.WriteLine("Modificaci�n tarjeta en banco: " + t); }
            //foreach (Tarjeta t in b.usuarios[0].tarjetas) { Debug.WriteLine("Modificaci�n tarjeta en usuario: " + t); }
